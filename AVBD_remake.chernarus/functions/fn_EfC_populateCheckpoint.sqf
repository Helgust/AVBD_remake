...
Example: _null = [tower1,tower2,"wp1","wp2","wp3","wp4"] call HLG_fnc_EfC_populateCheckpoint;
...
_unit01 = _grp01 createUnit [selectRandom ["CUP_B_USMC_Soldier","CUP_B_USMC_Soldier_GL"], [0,0,0], [], 0, "CAN_COLLIDE"];
_unit01 setPosASL _pos01;
_unit02 = _grp01 createUnit [selectRandom ["CUP_B_USMC_Soldier_AR"], [0,0,0], [], 0, "CAN_COLLIDE"];
...
_unit03 = _grp02 createUnit [selectRandom ["CUP_B_USMC_Soldier","CUP_B_USMC_Soldier_LAT"], [0,0,0], [], 0, "CAN_COLLIDE"];
_unit03 setPosASL _pos03;
_unit04 = _grp02 createUnit [selectRandom ["CUP_B_USMC_Soldier_Sniper_M40A3"], [0,0,0], [], 0, "CAN_COLLIDE"];
...
_unit05 = _grp03 createUnit [selectRandom ["CUP_B_USMC_Soldier","CUP_B_USMC_Soldier_TL"], getMarkerPos _marker01, [], 0, "CAN_COLLIDE"];
_unit06 = _grp03 createUnit [selectRandom ["CUP_B_USMC_Soldier_GL","CUP_B_USMC_Soldier_AR"], getMarkerPos _marker01, [], 0, "CAN_COLLIDE"];
_unit07 = _grp03 createUnit [selectRandom ["CUP_B_USMC_Soldier_Medic","CUP_B_USMC_Soldier"], getMarkerPos _marker01, [], 0, "CAN_COLLIDE"];
_unit08 = _grp03 createUnit ["CUP_B_USMC_Soldier_LAT", getMarkerPos _marker01, [], 0, "CAN_COLLIDE"];
