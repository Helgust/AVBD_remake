...
// WEAPONS
_box addWeaponCargoGlobal ["CUP_arifle_M4A1_standard_black",2 + (round random 2)];
_box addWeaponCargoGlobal ["CUP_arifle_M4A1_BUIS_GL",1 + (round random 1)];
_box addWeaponCargoGlobal ["CUP_arifle_MG36_wdl",1 + (round random 1)];
_box addWeaponCargoGlobal ["CUP_srifle_M110_black",1];

// AMMO

// 5.56 mm, tracer/non-tracer
if (random 100 < 50) then {_box addMagazineCargoGlobal ["CUP_30Rnd_556x45_Stanag_Tracer_Red",24 + (round random 8)]} else {_box addMagazineCargoGlobal ["30Rnd_556x45_Stanag_Tracer_Red",24 + (round random 8)]};
if (random 100 < 50) then {_box addMagazineCargoGlobal ["CUP_100Rnd_556x45_BetaCMag",6 + (round random 2)]} else {_box addMagazineCargoGlobal ["150Rnd_556x45_Drum_Mag_Tracer_F",6 + (round random 2)]};

// 7.62 mm
_box addMagazineCargoGlobal ["CUP_20Rnd_762x51_B_M110",8 + (round random 4)];
