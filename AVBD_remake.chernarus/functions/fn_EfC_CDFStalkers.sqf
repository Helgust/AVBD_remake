...
_newGrp = grpNull;
_newGrp = [[_axisX,_axisY,0], Resistance, configFile >> "CfgGroups" >> "West" >> "CUP_B_CDF" >> "Infantry_MNT" >> (selectRandom ["CUP_B_CDFInfSection_AT_MNT","CUP_B_CDFInfSquad_MNT","CUP_B_CDFInfSection_MG_MNT"]), [], [], [0.2, 0.2]] call BIS_fnc_spawnGroup;
